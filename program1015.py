...
#  and in terms of coding space and time than a for a loop. 
#  Typically, they are written in a single line of code. 
#  The below program depicts the difference between for loops and
#   list comprehension based on performance.
